...
<div class="w3-container w3-center" style="padding:128px 16px" id="body">
    ...
    <div id="London" class="tabcontent w3-center">
        ...
        <h3>Click to Upload Assignments</h3>
        <p>
        <table>
            <form action="#">
                <td>Assignment Submission
                </td>
                <td>Remarks & Instructions
                </td>
                <td>
                ...
                <tr>
                    <td><input type="file" name="AssignmentUpload" accept="file/*"></td>
