...
<div class="w3-container" style="padding:128px 16px" id="body" align="center">
    <div class="form-style-2 " align="left">
        <table style="width:100%">
            <tr>
                <th>
                    <div class="form-style-2-heading">Contact or leave feedback to us</div>
                    <form action="#" method="post" accept-charset="utf-8">
                        <label for><span>Remarks<span class="required"></span></span><textarea rows="10" cols="50" required></textarea> </label>
        ...
        <span><a href="studentDashboard.jsp"><input type="button" value="Move to Dashboard"/>&nbsp;</a></span>
    </div>
